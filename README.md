# How to run
OntoLDiff is implemented in Java, so before running it, please make sure that you have Java Runtime Environment (JRE) installed on your computer. Please include all dependencies (the .jar files shown above) in your program when running OntoLDiff
